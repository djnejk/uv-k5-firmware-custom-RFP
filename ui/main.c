...
void UI_DisplayAudioBar(void)
{
	if (gSetting_mic_bar)
	{
		...
		uint8_t *p_line = gFrameBuffer[line]+10;
...
int jakdaleko = 38;
			memcpy(gFrameBuffer[2] + jakdaleko, logo_1, 44);
			memcpy(gFrameBuffer[3] + jakdaleko, logo_2, 44);
			memcpy(gFrameBuffer[4] + jakdaleko, logo_3, 44);
			memcpy(gFrameBuffer[5] + jakdaleko, logo_4, 44);
			memcpy(gFrameBuffer[6] + jakdaleko, logo_5, 44);
